...
-- Topmost | LOAD = EXACT order you asked for (IY → wait2 → Adonis → wait0.1 → FULL ToolAdjuster)
-- WAIT = hide UI + F1 + K to bring back anytime
-- EVERY SINGLE LINE INCLUDED - NO CUTS - NO PLACEHOLDERS
...
subtitle.Text = "IY → wait(2) → Adonis → wait(0.1) → FULL Weld Adjuster"
...
loadBtn.Text = "🚀 LOAD EXACT ORDER NOW"
...
loadBtn.MouseButton1Click:Connect(function()
    ...
    print("🔥 Loading Adonis now...")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Pixeluted/adoniscries/main/Source.lua"))()

    wait(0.1)

    print("🔥 Loading FULL Weld/Tool Adjuster script now...")

    -- YOUR EXACT FULL SCRIPT STARTS HERE (copied 100% verbatim)
    ...
    local function applyOffset(tool)
        ...
        if tool.Name == "Boombox" then
            ...
            -- COLOR FIX (stops weird tinting/glitching when deep behind body)
    ...
    equipAllButton.TextColor3 = Color3.fromRGB(255,255,255) -- FIX: visible color
    ...
    unequipAllButton.TextColor3 = Color3.fromRGB(255,255,255) -- FIX: visible color
    ...
    -- After everything finishes, kill the loader UI
    task.wait(1)
    screenGui:Destroy()
    print("✅ FULL CHEAT LOADED EXACTLY AS REQUESTED - Loader UI deleted forever")
end)
...
print("Click LOAD for your EXACT order or WAIT and use F1+K later 🔥")
